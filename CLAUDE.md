...
## 🧠 Karpathy Coding Guidelines (ALL agents must follow)

> Derived from [Andrej Karpathy's observations](https://x.com/karpathy/status/2015883857489522876) on LLM coding pitfalls. Biases toward caution over speed — use judgment for trivial tasks.
