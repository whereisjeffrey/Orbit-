...
file_path = 'TranslateHelper/SettingsView.swift'

# Check if file is already in the project
unless group.files.find { |f| f.path == 'SettingsView.swift' || f.path == file_path }
  # Add file to group
  file_reference = group.new_file('SettingsView.swift')
  # Add file to target source build phase
  target.source_build_phase.add_file_reference(file_reference)
  puts "Added SettingsView.swift to target"
else
  puts "SettingsView.swift already in project"
end
